    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <form class="form-inline col-sm-2 method='GET'">
                <input class="form-control mr-sm-2" name="cari"  type="search" placeholder="Cari alamat cabang" aria-label="Search">
            ...
            <table class="table table-bordered text-center">
                <br></br>
                <tr>
                <th width=200>ID Cabang</th> <th width=400>Alamat Cabang</th> <th width=250>No_Telp Cabang</th> <th width=300>Jam Operasional</th> <th width=200>Aksi</th>
                </tr>
                <?php  
                    while($user_data = mysqli_fetch_array($result)) {         
                        echo "<tr>";
                        echo "<td><center>".$user_data['idcabang']."</center></td>";
                        echo "<td><center>".$user_data['alamatcabang']."</center></td>";
                        echo "<td><center>".$user_data['notelpcabang']."</center></td>";
                        echo "<td><center>".$user_data['jamoperasional']."</center></td>";
                        
                        echo "<td><center><a class='btn btn-success' href='#?idcabang=$user_data[idcabang]'>Edit</a> |
                         <a class='btn btn-danger' href='#?idcabang=$user_data[idcabang]'>Delete</a></td></tr>";        
                    }
                ?>
            </table>
        </div>
